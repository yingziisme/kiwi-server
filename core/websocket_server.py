...
class WebSocketServer:
    def __init__(self, config: dict, mysql_utils):
        self.config = config
    ...
    def _create_processing_instances(self):
        ...
        return (
            ...
            aec.create_instance(
                self.config["selected_module"]["AEC"]
            ),
        )
    ...
    async def _handle_connection(self, websocket):
        ...
        handler = ConnectionHandler(self.config, self.mysql_utils, self._vad, self._asr, self._llm, self._tts, self._memory, self.intent)
